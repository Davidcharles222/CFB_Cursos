//SOME -> retorna true se na arrya conter pelo menos um do valor pesquisado, mesmo procedimento de parâmetros do map, filter e find.
...
btnVerificar.addEventListener('click',(evt)=>{//criando evento click botão
    ...
    const ret = elementos_array.some((el,ind)=>{//utilizando every com array function
