...
const dgv=(configdgv)=>{
    ...
    dgvDados.innerHTML=''//limpar as linhas
    ...
    .then(res=>{
        ...
        res.forEach(el => {
            ...
            const c1 = document.createElement('div');//coluna 1
            c1.setAttribute('class','coluna c1');
            c1.innerHTML=el.id;
            dgvLinha.appendChild(c1);

            const c2 = document.createElement('div');//coluna 2
            c2.setAttribute('class','coluna c2');
            c2.innerHTML=el.produto;
            dgvLinha.appendChild(c2);

            const c3 = document.createElement('div');//coluna 3
            c3.setAttribute('class','coluna c3');
            c3.innerHTML=el.marca;
            dgvLinha.appendChild(c3);

            const c4 = document.createElement('div');//coluna 4
            c4.setAttribute('class','coluna c4');
            c4.innerHTML=el.modelo;
            dgvLinha.appendChild(c4);

            const c5 = document.createElement('div');//coluna 5
