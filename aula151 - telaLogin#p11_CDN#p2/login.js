class Login{
    ...
    static config={
        cor:null,//048
        img:null,
        endpoint:null,//https://371704cc-1f42-402a-bd42-3f1864b7f798-00-4bt7ox3wijnv.kirk.replit.dev/
    };
    ...
    static login=(callback_ok,callback_naook,config)=>{
       ...
       `.botoesLogin button{cursor: pointer; background-color: #${this.config.cor}; color: #fff; border-radius: 5px; padding: 10px;width: 110px; box-sizing: inherit;}`+
       " .campoLogin label{font-size: 18px;}"+
        ".campoLogin input{font-size: 18px; padding: 5px; background-color: #fff; border-radius: 5px; width: 90%;}"
